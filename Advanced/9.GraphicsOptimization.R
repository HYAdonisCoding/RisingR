######第9章 R君的可视化威力之图形优化The power of R language visualization: Graphics optimization########
#######9.1 添加图形元素#####
########9.1.1 坐标轴#########
...
# 修改坐标轴标签格式
windowsFonts(myFont = windowsFont("STKaiti")) 
ggplot(data = mtcars,aes(x = wt,y = mpg)) + 
  geom_point() + 
  theme(axis.title = element_text(family = "STKaiti",
                                  face = "bold",
                                  color = "red",
                                  size = rel(2)))
